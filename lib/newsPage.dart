        ...
        children: [
          ListTile(
            leading: Image.network(
                "https://pics5.baidu.com/feed/6159252dd42a2834fa78ccb96664b0e217cebf84.jpeg?token=29df408c914ee7a0d77ccf9c4ea05348",width: 75,
                height: 200),
            title: Text("国家卫健委：5月9日新增确诊病例11例，均为境外输入病例",
              overflow: TextOverflow.ellipsis,),
            subtitle: Text("5月9日0—24时，31个省（自治区、直辖市）和新疆生产建设兵团报告新增确诊病例11例，均为境外输入病例（上海4例，广东2例，陕西2例，浙江1例，四川1例，云南1例）；无新增死亡病例；无新增疑似病例。", maxLines: 4,overflow: TextOverflow.ellipsis),
            trailing: Icon(Icons.keyboard_arrow_right),
            contentPadding: EdgeInsets.symmetric(horizontal: 20),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>new detailPageState (news:new News(title[0],description[0],picUrl[0]))));
            },
